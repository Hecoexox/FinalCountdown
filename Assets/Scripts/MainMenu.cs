...
public class MainMenu : MonoBehaviour
{
    ...
    {
        float duration = 0.5f; // h�zl� ama smooth
        float distance = -500f; // ne kadar a�a�� kayacak
        float elapsed = 0f;
        ...
        while (elapsed < duration)
        {
            ...
            t = Mathf.SmoothStep(0, 1, t); // yumu�ak ge�i�
        ...
        // Pozisyonlar� kesin olarak hedefe oturt
    ...
    public void QuitGame()
    {
        ...
        Application.Quit();
#if UNITY_EDITOR
    UnityEditor.EditorApplication.isPlaying = false; // Edit�rde �al��may� durdurur
#else
        Application.Quit(); // Build'de oyunu kapat�r
#endif
    }
}
